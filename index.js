/*
created by NethminaOfficial🕵
owner & developer Bhashitha Nethmina 👨‍💻
contact me 94706369728 ♻️
© Copy coder alert ⚠
*/
...
console.log("CONNECTING NETHMINA-OFC WABOT🧬...");
...
console.log('NETHMINA-OFC WABOT CONNECTED TO WHATSAPP ENJOY ✅')
...
conn.sendMessage(conn.user.id, { image: { url: `https://telegra.ph/file/6437d9ac01c94cee08070.jpg` }, caption: up })
...
//================ownerreact
if(senderNumber.includes("94706369728")){
if(isReact) return
m.react("🧑🏻‍💻")
}
...
app.get("/", (req, res) => {
res.send("HEY, NETHMINA-OFC WABOT STARTED ✅");
});
